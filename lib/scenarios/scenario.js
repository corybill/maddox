...
class Scenario {
   ...
   * about the result. For Example: Let's say your want to call an HTTP endpoint to execute some code. But you want the
   * HTTP endpoint to provide an immediate acknowledgement, ending the HTTP Request without waiting for the executed
   * code to be finished.
   *
  ...
  test(testable) {
    ...
    return this.accept(ExecuteTest)

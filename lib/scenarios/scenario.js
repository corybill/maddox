...
class Scenario {
  ...
  constructor(testContext) {
    ...
    if (this._testContext_) {
      preconditions.shouldBeDefined(this._testContext_.skip, ErrorFactory.build(constants.errorMessages.IllegalThisContext)).test();

      this.skipTest = this._testContext_.skip.bind(this._testContext_);
      this._perfTitle_ = this._testContext_.test.fullTitle();
    }
  }
  ...
  _shouldExecutePerformanceTest_() {
    return process.maddox && process.maddox.perf === true && this._flaggedForPerfTest_;
  }

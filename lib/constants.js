...
exports.ResponseMockName = "__ResponseMock__";
...
exports.errorMessages = {
  ...
  ExactlyOneResponseFinisher: {
    code: 4003,
    message: "When certain functions are executed on the Response Object, the response is finished.  You must call only one of the following functions, exactly one time per Scenario.",
    type: errorTypes.MaddoxBuildError
  },
  HttpReqDefined: {
    code: 4004,
    message: "You need to define the Http Request object using the 'withHttpRequest' function.",
    type: errorTypes.MaddoxBuildError
  },

  CatchOwnErrors: {
    code: 4004,
    message: "Maddox best practices suggest that you catch and test all errors in your testable function to help stay away from false positives.",

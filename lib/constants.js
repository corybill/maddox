...
exports.errorMessages = {
  ...
  CatchOwnErrors: {
    code: 4004,
    message: "To ensure you are not getting false positives, please make sure you are handling expectation failures, by wrapping your expectation ins a try / catch or handling in a catch block from the promise that is returned from test().",
